<div>
    ...
    <div wire:poll.visible>
        <x-table :headers="['#', __('Subject'), __('Name'), __('Header'), __('Footer')]" :records="$records">
            @php
            ...
            @foreach ($records as $record)
                <tr wire:key="{{ $record->id }}">
                    <td>{{ $id-- }}</td>
                    <td>
                        <strong class="d-block">{{ $record->subject }}</strong>
